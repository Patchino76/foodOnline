...
class UserProfile(models.Model):
   ...
   profile_picture = models.ImageField(default='default.jpg', upload_to='users/%Y/%m/%d') #path to the picture
   cover_photo = models.ImageField(default='default.jpg', upload_to='users/%Y/%m/%d') #path to the cover photo
